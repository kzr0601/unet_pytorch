...
modelpath = './checkpoints_init_aug/'
print(modelpath)
...
def train_net(net,
    ...
    # 1. Create dataset
    try:
        train_set = CarvanaDataset(dir_img, dir_mask, img_scale, False)
        val_set = CarvanaDataset(valid_dir_img, valid_dir_mask, img_scale, True)
    except (AssertionError, RuntimeError):
        train_set = BasicDataset(dir_img, dir_mask, img_scale, False)
...
if __name__ == '__main__':
    ...
    #params = torch.load('checkpoints_change_init/bestmodel.pth')
